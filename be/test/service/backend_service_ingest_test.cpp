...
protected:
    ...
    void _create_mow_tablet() {
        ...
        auto tablet = std::make_shared<Tablet>(*_engine, tablet_meta, _data_dir.get(), "ingest_test");
    ...
    RowsetSharedPtr _write_rowset(int64_t rowset_id, const PUniqueId& load_id,
                                  int num_segments, int rows_per_segment) {
